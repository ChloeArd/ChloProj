document.getElementById("button1").addEventListener("click", function() {
    ...
    let location = ["Paris", "Cannes", "Nord", "Marseille", "Bretagne", "Lyon"];
    let verb = ["chanter", "manger", "sauter", "courir", "dormir", "danser", "crier"];
